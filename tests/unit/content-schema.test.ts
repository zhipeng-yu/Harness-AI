...
describe("chapter content contract", () => {
  ...
  it("exposes three published chapters and 15 awaiting-audio chapters by default", async () => {
    ...
    expect(chapters.slice(3).every((chapter) => chapter.status === "awaiting_audio")).toBe(true);
