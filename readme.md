...
网站与幻灯片采用 Apple 风格的浅灰画布、白色圆角面板、轻字重与细线分组。已发布章节按现有摘要生成桌面 16:9 幻灯片；第一章 18 页、8 张插画，第二章 17 页、4 张插画。文字随幻灯片宽度缩放，摘要完整显示，不以省略号截断，也不拆页或增加页内滚动。支持方向键翻页，最后一页进入反思、行动与 Artifact 工作区。当前不做手机专项适配；插画当前以灰度显示，后续重绘黑白风格。
