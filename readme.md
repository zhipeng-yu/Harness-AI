...
课程采用博客式分页阅读：先了解路线，再逐节阅读解释与例子，最后回顾概念、场景和误区并进入实践。第一章 30 页，第二章 28 页；两章共 27 节详细讲解，每节独立一页，正文完整显示，补充例子明确标注为说明性例子。页面保留浅灰画布与白色圆角面板，正文为主、灰度插画为辅，高度随内容展开，窄窗口自动变为单栏。支持目录跳转、按钮和方向键翻页，最后一页进入反思、行动与 Artifact 工作区；当前阅读页不持久化。
