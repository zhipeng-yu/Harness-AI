...
当前已有 18 章目录，前四章已经用户审批并发布：第一章《获取超体的脑机接口：获得 10 倍输出能力》、第二章《获取语言杠杆：掌握 Vibe Coding，放大调用智能的能力》、第三章《人和 AI 的不变：理解分工，练习意义压缩》、第四章《管理的本质：重构 AI 工作流，把自己的瓶颈上移》。其余 14 章为 `awaiting_audio`。
...
课程采用博客式分页阅读：先了解路线，再逐节阅读解释与例子，最后回顾概念、场景和误区并进入实践。第一章 30 页，第二章 28 页，第三章 51 页，第四章 54 页；四章共 104 节详细讲解，每节独立一页，正文完整显示，补充例子明确标注为说明性例子。页面保留浅灰画布与白色圆角面板，正文为主、灰度插画为辅，高度随内容展开，窄窗口自动变为单栏。支持目录跳转、按钮和方向键翻页，最后一页进入反思、行动与 Artifact 工作区；当前阅读页不持久化。
